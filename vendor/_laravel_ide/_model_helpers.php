...
namespace App\Models {
     ...
     * @property \Illuminate\Support\Carbon|null $access_expiry_date
     * @property mixed $type
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Admin>|Admin whereAccessExpiryDate($value)
     ...
     *
     * @method static \Illuminate\Database\Eloquent\Builder<CategoryModel>|CategoryModel newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<CategoryModel>|CategoryModel newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<CategoryModel>|CategoryModel query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectExpression($expression, $as)
     * @method static mixed selectRaw($expression, array $bindings)
