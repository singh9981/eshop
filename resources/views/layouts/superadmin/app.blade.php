...
<head>
    ...
    <title>{{ config('app.name', 'Duralux || Dashboard') }}</title>

    <!-- Fonts -->
    <link rel="dns-prefetch" href="//fonts.bunny.net">
    <link href="https://fonts.bunny.net/css?family=Nunito" rel="stylesheet">

    <link rel="shortcut icon" type="image/x-icon" href="{{asset('superadmin/images/favicon.ico')}}" />

    <link rel="stylesheet" type="text/css" href="{{asset('superadmin/css/bootstrap.min.css')}}" />

    <link rel="stylesheet" type="text/css" href="{{asset('superadmin/vendors/css/vendors.min.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{asset('superadmin/vendors/css/daterangepicker.min.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{asset('superadmin/css/theme.min.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{asset('superadmin/vendors/css/dataTables.bs5.min.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{asset('superadmin/vendors/css/select2.min.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{asset('superadmin/vendors/css/select2-theme.min.css')}}" />
...
@endif
    ...
    <script src="{{asset('superadmin/vendors/js/circle-progress.min.js')}}"></script>
    ...
    <script src="{{asset('superadmin/vendors/js/select2-active.min.js')}}"></script>
    <script src="{{asset('superadmin/js/projects-init.min.js')}}"></script>

    <script src="{{asset('superadmin/vendors/js/tagify.min.js')}}"></script>
    <script src="{{asset('superadmin/vendors/js/tagify-data.min.js')}}"></script>
    <script src="{{asset('superadmin/vendors/js/quill.min.js')}}"></script>
