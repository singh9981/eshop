                        ...
                        @else
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu rounded">
                                    ...
                                    <a href="{{ route('user.profile') }}" class="dropdown-item"> Account Settings</a>
                                    <a href="{{ route('user.profile') }}" class="dropdown-item"> My Account</a>
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-primary ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarCollapse">
                            <div class="navbar-nav ms-auto py-0">
                                ...
                                <a href="{{route('user.products')}}" class="nav-item nav-link">Shop</a>
                                <a href="{{route('user.product.show',1)}}" class="nav-item nav-link">Single Page</a>
                                ...
                                <a href="{{route('user.contact')}}" class="nav-item nav-link me-2">Contact</a>
